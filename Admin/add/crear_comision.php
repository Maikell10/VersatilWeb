        ...
        <div class="section">
            <div class="container" >
                ...
                <div class="col-md-auto col-md-offset-2">
                    <h1 class="title"><i class="fa fa-search-plus" aria-hidden="true"></i>&nbsp;Seleccione Compañía Emisora
                    </h1>  
                </div>
                ...
                <form class="form-horizontal" id="frmnuevo" style="width: 50%">
                    <div class="form-row">
                      <div class="form-group col-md-12">
                            <select class="custom-select" id="cia" name="cia" required required onchange="document.location.href=this.value">
                                <option value="">Seleccione la Compañía</option>
                                  <?php
                                    for($i=0;$i<sizeof($cia);$i++)
                                      {  
                                  ?>
                                      <option value="<?php echo 'cant_poliza.php?cia='.$cia[$i]["idcia"];?>"><?php echo utf8_encode($cia[$i]["nomcia"]);?></option>
                                  <?php } ?> 
                            </select>
                      </div>
                    </div>
