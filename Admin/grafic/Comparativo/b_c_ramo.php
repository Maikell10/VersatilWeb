...
<body class="profile-page ">
    ...
    <div class="main main-raised">
        ...
        <div class="section">
            ...
            <a href="javascript:history.back(-1);" data-tooltip="tooltip" data-placement="right" title="Ir la página anterior" class="btn btn-info btn-round"><- Regresar</a>
                ...
                <div class="col-md-auto col-md-offset-2">
                  <center>
                    <h1 class="title">Comparativo de Prima Cobradas por Ramo</h1> 
                    <br/>
                    <a name="nombre"></a>
                    <a href="../comparativo.php" class="btn btn-info btn-lg btn-round">Menú de Gráficos</a></center>
                </div>
                <br>
      ...
      <form class="form-horizontal" action="c_ramo.php" method="get">
        <div class="form-row">
          <div class="form-group col-md-6">
          <label>Seleccione el Año a Comparar:</label>
          ...
          <div class="form-group col-md-6">
          <label>Seleccione el Mes a Comparar:</label>
