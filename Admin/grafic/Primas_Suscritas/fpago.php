...
if(isset($_SESSION['seudonimo'])) {
  ...
  $obj1= new Trabajo();
  $fpago = $obj1->get_distinct_element_fpago($desde,$hasta,$_GET['cia'],$_GET['ramo']); 
  ...
  for($i=0;$i<sizeof($fpago);$i++)
    {  
      ...
      $obj2= new Trabajo();
      $fpagoPoliza = $obj2->get_poliza_graf_4($fpago[$i]['fpago'],$_GET['ramo'],$desde,$hasta,$_GET['cia']); 
            ...
            <div class="container">
                ...
                <div class="col-md-auto col-md-offset-2">
                  <center>
                    ...
                    <a href="busqueda_fpago.php" class="btn btn-info btn-lg btn-round"><-</a>
                </div>
                <br>
