...
if ($permiso!=3) { 
  ...
  $obj1= new Trabajo();
  $ramo = $obj1->get_distinct_element_ramo2($desde,$hasta,$cia,$tipo_cuenta); 
...
if ($permiso==3) {  
  ...
  $obj1= new Trabajo();
  $ramo = $obj1->get_distinct_element_ramo2_by_user($desde,$hasta,$cia,$tipo_cuenta,$asesor_u); 
        ...
        <div class="section">
            ...
            <a href="javascript:history.back(-1);" data-tooltip="tooltip" data-placement="right" title="Ir la página anterior" class="btn btn-info btn-round"><- Regresar</a>
                ...
                <div class="col-md-auto col-md-offset-2">
                  <center>
                    <h1 class="title">Prima Promedio por Ramo</h1> 
                    <br/>
                    
                    <a href="../porcentaje.php" class="btn btn-info btn-lg btn-round">Menú de Gráficos</a></center>
                    <center><a  class="btn btn-success" onclick="tableToExcel('Exportar_a_Excel', 'Prima Promedio por Ramo')" data-toggle="tooltip" data-placement="right" title="Exportar a Excel"><img src="../../../assets/img/excel.png" width="40" alt=""></a></center>
                </div>
                <br>
    ...
    <table class="table table-hover table-striped table-bordered display table-responsive nowrap" id="Exportar_a_Excel">
       <thead style="background-color: #00bcd4;color: white; font-weight: bold;">
        <tr>
          ...
          <th scope="col">Prom Prima Suscrita</th>
      ...
      data:{
        ...
        datasets:[{
          ...
          data:[<?php for($i=sizeof($ramo); $i > 0; $i--)
            {  ?>
                '<?php echo ($sumatotalRamo[$x[$i]])/$cantArray[$x[$i]]; ?>',
            <?php }?>
          ],
