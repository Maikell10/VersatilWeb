...
if(isset($_SESSION['seudonimo'])) {
  ...
  require_once("../class/clases.php");
	...
	$obj1= new Trabajo();
  	$poliza = $obj1->editarPoliza($id_poliza,$n_poliza,$fhoy,$t_cobertura,$fdesdeP,$fhastaP,$currency,$tipo_poliza,$sumaA,$z_produc,$codasesor,$ramo,$cia,$idtitular[0]['id_titular'],$idtomador[0]['id_titular'],$asesor_ind,$t_cuenta,$obs); 
...
<body class="profile-page ">
    ...
    <script>
	  ...
	  alertify.confirm('Póliza Cargada con Exito!', '¿Desea revisar otra Póliza Pendiente?', 
	  	function(){ 
	  		window.location.replace("b_pendientes.php?cond=1");
	  		alertify.success('Ok') 
	  	}, 
	  	function(){ 
